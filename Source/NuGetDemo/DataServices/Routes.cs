...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(NuGetDemo.NuGetRoutes), "Start")]
...
namespace NuGetDemo
{
    public static class NuGetRoutes {
        ...
        private static void MapRoutes(RouteCollection routes) {
            ...
            ServiceRoute serviceRoute = new ServiceRoute("nuget", factory, typeof(Packages));
